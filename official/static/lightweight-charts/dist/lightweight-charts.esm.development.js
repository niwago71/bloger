...
var DataLayer = /** @class */ (function () {
    ...
    DataLayer.prototype._private__getUpdateResponse = function (updatedSeries, firstChangedPointIndex) {
        ...
        if (firstChangedPointIndex !== -1) {
            ...
            this._private__seriesRowsBySeries.forEach(function (data, s) {
                dataUpdateResponse._internal_series.set(s, { _internal_data: data });
            });
            // if the series data was set to [] it will have already been removed from _seriesRowBySeries
            // meaning the forEach above won't add the series to the data update response
            // so we handle that case here
            if (!this._private__seriesRowsBySeries.has(updatedSeries)) {
                dataUpdateResponse._internal_series.set(updatedSeries, { _internal_data: [] });
            }
            ...
            dataUpdateResponse._internal_series.set(updatedSeries, { _internal_data: seriesData || [] });
        }
...
var ChartApi = /** @class */ (function () {
    ...
    ChartApi.prototype.addBaselineSeries = function (options) {
        ...
        options = migrateOptions(options);
        patchPriceFormat(options.priceFormat);
        var strictOptions = merge(clone(seriesOptionsDefaults), baselineStyleDefaults, options);
    ...
    ChartApi.prototype._private__sendUpdateToChart = function (update) {
        ...
        update._internal_series.forEach(function (value, series) { return series._internal_setData(value._internal_data); });
